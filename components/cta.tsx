      ...
      <article className={styles.cta}>
          <div className={styles.card}>
            ...
            <div className={styles.copy}>
              <p>Construa e escale serviços na maior das nuvens, a <span>AWS</span>. Inscreva-se para receber atualizações frequentes sobre o livro e cloud e ser notificado do lançamento. </p>
            </div>
